...
const Offers = () => {
  ...
  return (
    <div>
      ...
      <h2 className="text-[#7991A4] text-base font-medium font-inter">
        Personalized offer for you
      </h2>
      <div
        onClick={() => setIsCreateCouponModalOpen(true)}
        className="bg-[#FFFFFF] rounded-lg flex items-center gap-3 p-5 h-32 max-w-[540px] cursor-pointer"
      >
        <div className="w-[70px] h-[70px] rounded-full bg-[#A4F4E7] flex justify-center items-center">
          <img src={promoIcon} alt="promoIcon" />
        </div>
        <div className="space-y-2">
          <h3 className="text-[#000000] text-2xl font-medium font-inter">
            Custom offer
          </h3>
          <p className="text-[#7991A4] text-sm font-normal font-inter">
            Thrill customers with complimentary discounts on every order.
          </p>
        </div>
      </div>
      {createCustomModel && (
