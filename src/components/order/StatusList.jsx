            ...
            <section className="flex flex-col gap-6 w-full h-full">
                ...
                <section className="flex justify-start items-center">
                    <button
                        ...
                        className={`flex justify-center items-center gap-[10px] px-[30px] py-3 border-b-[3px] ${selectTab === "capsico"
                                ? "border-[#003CFF]"
                                : "border-transparent"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex justify-center items-center gap-[10px] px-[30px] py-3 border-b-[3px] ${selectTab === "quickly"
                                ? "border-[#003CFF]"
                                : "border-transparent"
                            }`}
                    >
