...
const DeliveryAgentComp = () => {
    ...
    const handleValueChange = (value) => {
        ...
        if (value === 'remove') {
            ...
            navigate('/admin/delivery-agent/123')
        }
    }
    ...
    return (
        <TableRow>
            ...
            <TableCell className="text-[#1D1929] text-xs font-normal font-sans">1264903</TableCell>
            <TableCell className="text-[#1D1929] text-xs font-bold font-sans">Ashok sharma</TableCell>
            <TableCell className="text-[#1D1929] text-xs font-normal font-sans">Lucknow</TableCell>
            <TableCell className="text-[#1D1929] text-xs font-normal font-roboto">
                <div className={`${status === 'Available Now' ? 'text-[#3465BD] bg-[#D3E2FF]' : 'text-[#3A3A3A] bg-[#F0F0F0]'} w-24 flex justify-center items-center h-[24px] text-[10px] font-normal font-sans rounded-[10px]`}>{status}</div>
            </TableCell>
