        ...
        <>
            <TableRow>
                ...
                <TableCell className="text-[#1D1929] text-[12px] font-normal font-roboto">
                    {item?.addresses?.[0]?.city || "N/A"}
                </TableCell>
                <TableCell className="text-[#667085] text-[10px] font-semibold font-inter">
                    {item.totalSpent || "N/A"}
                </TableCell>
                ...
                <TableCell className="text-[#1D1929] text-xs font-normal font-sans">
                    <div className="flex gap-2 items-center">
                        <Button onClick={handleEdit} size="xs" variant="capsico">View</Button>
                        <Button onClick={handleRemove} size="xs" variant="destructive">Remove</Button>
                    </div>
                </TableCell>
            </TableRow>
