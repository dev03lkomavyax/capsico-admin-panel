...
//                   <TableHead className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Start Time</TableHead>
//     <TableHead className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">End Time</TableHead>
...
const ContentManagement = () => {
  ...
  const getBanners = () => {
    ...
    const queryString = params.toString();
    const url = `/banner/getAllBannerType${
