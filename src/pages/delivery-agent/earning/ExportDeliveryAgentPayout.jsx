...
import { dateRangeSchema } from "@/schema/AddDeliveryAgentSchema";
...
const ExportDeliveryAgentPayout = ({ isModalOpen, setIsModalOpen }) => {
  ...
  const exportDeliveryPartnerPayouts = () => {
    fetchData(
      `/payout/export?startDate=${fromDate}&endDate=${toDate}&type=${type}&ownerType=DELIVERY_PARTNER&ownerId=${deliveryAgentId}`,
      { responseType: "blob" }
    );
  };

  //   useEffect(() => {
  //     exportDeliveryPartnerPayouts();
  //   }, []);
...
export default ExportDeliveryAgentPayout;
