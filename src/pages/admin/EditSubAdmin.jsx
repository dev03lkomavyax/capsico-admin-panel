...
const EditSubAdmin = () => {
    ...
    return (
        <AdminWrapper>
            <section className='px-0 py-0 w-full min-h-screen space-y-10'>
                ...
                <div className='bg-[#FFFFFF] px-8 pt-6 pb-20'>
                    <Form {...form}>
                        <form onSubmit={handleSubmit(onSubmit)} className=" w-full border-[1px] border-[#B9B9B9] rounded-xl bg-[#FFFFFF] px-10 py-9">
                            <h2 className='text-[#1064FD] text-2xl text-left font-bold font-nunito mb-4'>Edit sub admin</h2>
                            ...
                            <div className='flex justify-end'>
                                <Button type="submit" className='h-11 w-[190px] mt-20 bg-[#1064FD] hover:bg-[#1064FD] text-base'>Save Changes</Button>
                            </div>
                        </form>
                    </Form>
                </div>
