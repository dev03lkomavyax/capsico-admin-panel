      ...
      <section className="px-0 py-0 w-full">
        ...
        <Form {...form}>
          <form
            ...
            className=" mx-auto w-full border-[1px] border-[#B9B9B9] rounded-xl bg-[#FFFFFF] px-5 py-4"
          >
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          placeholder="*************"
                          className={`placeholder:text-[#A6A6A6] bg-[#F9FAFB] rounded-lg `}
                          {...field}
                        />
                        {isShowPassword ? (
                          <FaEyeSlash
                            onClick={() => setIsShowPassword(false)}
                            className="absolute text-gray-600 right-3 bottom-3 cursor-pointer text-lg"
                          />
                        ) : (
                          <FaEye
