...
import { EditProfileSchema5 } from "@/schema/restaurantSchema";
...
const EditProfile5 = ({ setPage, restaurant }) => {
    const form = useForm({
    ...
    const onSubmit = (data) => {
        ...
        fetchData(
            `/admin/restraunt-registration5/${restaurant?._id || restaurant?.id || "68550fa5acbd8e70333f11e0"
            }`,
            formData
        );
    };
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full py-5">
          <div>
            <div className="flex justify-between gap-2 mb-8">
              ...
              <Button size="lg" className="w-20 bg-[#1064FD]" type="submit">
                Save
              </Button>
            </div>
            ...
            <div className="border border-[#C2CDD6] rounded-md px-8 py-6 mt-7">
              ...
              <div className="mt-5 flex flex-col">
                ...
                <div className="px-3 py-2 text-xs mt-3 bg-[#EADBB1] rounded text-[#786224] border border-[#7D704C]">
                  ...
                  orders based on a FSSAI Application starting 1st jul 2021.If
                  you have applied for a FSSAI license or registration,please
                  come back to this page once it gets approved.Details fixed
            ...
            <div className="border border-[#C2CDD6] rounded-md px-8 py-6 mt-7">
              ...
              <div className="mt-5 flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <Button
                    type="button"
                    variant="capsico"
                    className="w-full px-3 py-[10px] flex gap-2 items-center justify-center rounded-md"
                  >
              ...
              <p className="text-[#858585] mt-1 text-xs">
                We will credit 1 in your account to validate your bank account
                details
              </p>
            </div>
          </div>
