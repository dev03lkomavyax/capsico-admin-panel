                ...
                {capsicoOrderData.length > 0 &&
                  capsicoOrderData.map((data) => (
                    <TableRow key={data.data}>
                      ...
                      <TableCell className="text-[#5C59E8] text-sm font-semibold font-sans">
                        #{data.orderID}
                      </TableCell>
                      <TableCell className="flex items-center gap-2">
                        <img
                      ...
                      <TableCell>
                        <p className="text-[#333843] text-sm font-medium font-sans mb-1">
                          {data.customer.name}
                        </p>
                        <p className="text-[#667085] text-xs font-normal font-sans">
                          {data.customer.email}
                        </p>
                      </TableCell>
                      <TableCell className="text-[#667085] text-sm font-medium font-sans">
                        ...
                        <div
                          className={`${
                            ...
                            (data.status === "Preparing" &&
                              "text-[#B6A92E] bg-[#FAFDD4]") ||
                            (data.status === "Delivered" &&
                              "text-[#0D894F] bg-[#E7F4EE]") ||
                            (data.status === "Cancelled" &&
                              "text-[#F04438] bg-[#FEEDEC]")
                          } px-3 w-fit flex justify-center items-center h-7 text-sm font-semibold font-inter rounded-full`}
                        >
                          {data.status}
                        </div>
                      </TableCell>
